...
import { CollegeDiscountBanner } from "@/components/CollegeDiscount";
import {
  getCanteenMenu,
  groupMenuByCategory,
...
import { getRestaurant, RESTAURANTS } from "@/config/canteen/restaurants";
import { toCartMenuItem } from "@/lib/canteen/cart";
  ...
  if (!restaurant) {
    return (
      <CanteenShopLayout search={search} onSearchChange={setSearch} sidebar={sidebar}>
        ...
        <Link href="/canteen" className="mt-2 inline-block text-sm font-semibold text-[#ED1C24]">
